package com.qiscus.sdk.call.wrapper.data.config;
...
public class CallConfig {
    //ui ux configuration
    private int waitingSound = R.raw.qiscus_phone_waiting;
    private int ringingSound = R.raw.qiscus_phone_ring;
    private int hangupSound = R.raw.qiscus_phone_hangup;
    private int backgroundDrawable = R.drawable.bg_qiscus_call;
    ...
    private int acceptVoiceCallButton = R.drawable.bt_qiscus_voice_call;
    private int acceptVideoCallButton = R.drawable.bt_qiscus_video_call;
    private int speakerActiveIcon = R.drawable.ic_qiscus_speaker;
    private int speakerInactiveIcon = R.drawable.ic_qiscus_no_speaker;
    private int micActiveIcon = R.drawable.ic_qiscus_mic;
    private int micInactiveIcon = R.drawable.ic_qiscus_no_mic;
    private int videoActiveIcon = R.drawable.ic_qiscus_video;
    private int videoInactiveIcon = R.drawable.ic_qiscus_no_video;
    private int frontCameraIcon = R.drawable.ic_qiscus_switch_camera_front;
    private int rearCameraIcon = R.drawable.ic_qiscus_switch_camera_back;


    //ui call interaction listener
    ...
    //call state listener
    private CallStateListener.OnCallDisconnectedListener onCallDisconnectedListener;
     ...
     *
     * @param onCallDisconnectedListener - listener
     */
    public CallConfig setOnCallDisconnectedListener(@NonNull CallStateListener.OnCallDisconnectedListener onCallDisconnectedListener) {
        this.onCallDisconnectedListener = onCallDisconnectedListener;
        return this;
    }
     ...
     */
    @Nullable
    public CallStateListener.OnCallDisconnectedListener getOnCallDisconnectedListener() {
        return onCallDisconnectedListener;
    }
    ...
    public interface CallButtonListener {
        interface OnEndCallClickListener {
            void onClick(Call callData, long callDurationInMillis);
        }

        interface OnCancelCallClickListener {
            void onClick(Call callData);
        }
    ...
    public interface CallStateListener {
        ...
        interface OnCallDisconnectedListener {
